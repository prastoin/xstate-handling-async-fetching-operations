...
<template>
    <span class="mb-2">
        ...
        <section v-bind:class="styleToApplyRef"
            class="w-full inline-flex items-center px-4 py-2 font-semibold leading-6 text-sm shadow rounded-md text-white   transition ease-in-out duration-150 cursor-not-allowed"
            disabled>
